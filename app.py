...
async def upload_and_query(image: UploadFile = File(...), query: str = Form(...)):
    try:
        ...
        llama_response1 = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        llama_response2 = make_api_request("meta-llama/llama-4-maverick-17b-128e-instruct")

        # Process responses
        responses = {}
        for model, response in [("llama1", llama_response1), ("llama2", llama_response2)]:
